...
expenseRouter.get('/fetchMonthlyCategoryExpense', fetchUser, async (req, res) => {
  try {
    ...
    // Get all unique categories for this user in the selected month
    ...
    const categoryExpenses = expenses.map((expense)=>{

    })
    // Ensure all categories are included, even if they have 0 expenses
