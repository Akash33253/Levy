...
function OnbordingText1(){
    return (
        <View className="flex flex-col items-center gap-[17px]">
            <Text className='text-dark-50 text-center text-[32px] font-bold'>Gain total control of your money</Text>
            <Text className='text-light-20 text-[16px] text-center w-[80%]'>Become your own money manager and make every cent count</Text>
        </View>
    )
}
