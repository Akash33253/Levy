      ...
      >
        <View className="w-full p-[20px] relative items-center justify-center flex flex-col">
          <View className=" w-full flex flex-row items-center">
            <Text className="text-dark-50 font-medium text-[14px] ">Hi {user?.name}</Text>
            <Pressable className="ml-auto mr-auto flex flex-row items-center px-[10px] py-[8px] rounded-[40px] border-[1px] border-light-60 gap-[3px]">
              <Image
