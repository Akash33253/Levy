                ...
                <View className="flex flex-col gap-[8px]">
                  {recentExpenses?.map((expense) => {
                    return <Pressable className="px-[14px] py-[17px] bg-light-80 rounded-[24px] flex flex-row gap-[9px] w-full items-center">
                      <View className="w-[60px] h-[60px] bg-light-60 rounded-[16px]">
                      </View>
                      <View className="flex-1 flex flex-row justify-between">
                        <View className="flex flex-col gap-[13px]">
                          ...
                          <Text
                            numberOfLines={2}
                            ellipsizeMode="tail"
                            className="w-[120px] text-[13px] font-medium text-light-20">
                            {expense?.description}
                          </Text>
                        </View>
                        <View className="flex flex-col gap-[13px] items-end just">
