            ...
            <View className="flex-1 bg-white rounded-t-[32px]">
                <View className="flex-1">
                    <View className="flex-1">
                        ...
                        <Text className="text-center text-light-20 font-inter-semibold text-[18px]">You don't have a budget</Text>
                        <Text className="text-center text-light-20 font-inter-semibold text-[18px]">Let's make one so you in control</Text>
                        </View>
                    </View>
