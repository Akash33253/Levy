...
export default function EditBudget({navigation}) {
    ...
    const editBudget = async () => {
        ...
        try {
            ...
            const response = await fetch(`http://${ipTemp}:5000/budget/updateCategoryBudget?id=67e7b8f9dffa27e5956c741d&category=Food&amount=5000`, {
                method: "POST",
                headers: {
            ...
            <Modal transparent animationType="fade" visible={alertModal === 'success'}>
                ...
                >
                    <View className="w-full bg-white  rounded-[20px] px-[24px] py-[19px] flex flex-col gap-[8px] items-center">
                        ...
                        />
                        <Text className="text-[14px] font-inter-medium">Budget has been successfully created</Text>
                    </View>
                </TouchableOpacity>
            </Modal>
            <Modal transparent animationType="fade" visible={alertModal === 'fail'}>
                ...
                >
                    <View className="w-full bg-white  rounded-[20px] px-[24px] py-[19px] flex flex-col gap-[8px] items-center">
                        ...
                        />
                        <Text className="text-[14px] font-inter-medium">Budget creation failed, try again later</Text>
                    </View>
                </TouchableOpacity>
            </Modal>
        </SafeAreaView>
