            ...
            <View className="flex-1 bg-white rounded-t-[32px]">
                <View className="flex-1">
                    <View className="flex-1">
                        ...
                        <Text className="text-center text-light-80 font-inter-semibold text-[18px]"></Text>
                        </View>
                    </View>
                    <View className="w-full px-[16px] py-[28px]">
                        <Pressable>
                            <View className="w-full bg-violet-100 rounded-[16px] p-[18px]">
                                <Text className="text-center text-light-20 font-inter-semibold text-[18px]">Create a Budget</Text>
                            </View>
                        </Pressable>
                    </View>
                </View>
