...
const AnimatedBar = ({budget}) => {
  ...
  return (
    <View className="flex flex-col  items-center gap-[5px] px-[32px] pt-[32px]">
      ...
      {
        budget.expense > budget.budgetAmount && <View className="flex flex-row items-center px-[8px] py-[4px] bg-red-100 gap-[8px] rouneded-[24px]"> 
