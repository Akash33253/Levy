    ...
    <SafeAreaView className="flex-1 bg-light-100">
      ...
      <View className="flex-1 py-[55px] px-[16px] gap-[60px] flex-col">
        ...
        <View className="flex flex-col gap-[16px] items-center">
          ...
          <View>
            <Text className="text-[16px] text-light-20 font-medium">Already have an account? <Pressable><Text className="text-violet-100 text-[16px]">Login</Text></Pressable></Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
