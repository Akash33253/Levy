        ...
        <SafeAreaView className="flex-1 bg-light-100">
            ...
            >
                <View className="flex-1">
                    ...
                    >
                        <View className="flex flex-colgap-[]">
                        {
                            monthlyExpenses.map((expenses, index) => {
                                return <View key={index} className="w-full flex gap-[13px] flex-col">
                                    <Text className="text-black text-[18px] font-semibold">{expenses[0]}</Text>
                                </View>
                            })
                        }
                        </View>
