...
export default function Report({ navigation }) {
    ...
    return (
        <SafeAreaView className="bg-[#FFFFFF] flex-1">
            ...
            <View className="flex-1 flex gap-[20px] flex-col relative">
                    <RingWithSegments />
                    <Text className="absolute left-[130px] top-[100px] text-[black] font-inter-bold text-[32px]">&#8377; {monthlyTotalExpense}</Text>
