                                        ...
                                        <View className="flex flex-col gap-[8px]">
                                            {
                                                expenses[1].map((expense) => {
                                                    return <Pressable key={expense?._id}>
                                                        <Pressable key={exp} onPress={()=>{navigation.navigate('expenseDetail')}} className="px-[14px] py-[17px] bg-light-80 rounded-[24px] flex flex-row gap-[9px] w-full items-center">
                                                            <View
                                                                style={{
