...
export default function EditExpense({ navigation }) {
    ...
    return (
        <SafeAreaView className="flex-1 bg-red-100">
            <TopHeader navigation={navigation} title={'Update Expense'} theme={'dark'} />
                    ...
                    <View className="w-full p-[16px]">
                        <Pressable
                            ...
                            <View className="w-full bg-violet-100 rounded-[16px] p-[18px]">
                                <Text className="text-center text-light-80 font-semibold text-[18px]">Update</Text>
                            </View>
                        </Pressable>
                    </View>
                </View>
            ...
            <Modal transparent animationType="fade" visible={alertModal === 'success'}>
                ...
                >
                    <View className="w-full bg-white  rounded-[20px] px-[24px] py-[19px] flex flex-col gap-[8px] items-center">
                        ...
                        />
                        <Text className="text-[14px] font-medium">Expense has been successfully updated</Text>
                    </View>
                </TouchableOpacity>
            </Modal>
            <Modal transparent animationType="fade" visible={alertModal === 'fail'}>
                ...
                >
                    <View className="w-full bg-white  rounded-[20px] px-[24px] py-[19px] flex flex-col gap-[8px] items-center">
                        ...
                        />
                        <Text className="text-[14px] font-medium">Expense updation failed, try again later</Text>
                    </View>
                </TouchableOpacity>
            </Modal>
        </SafeAreaView>
