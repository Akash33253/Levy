        ...
        <SafeAreaView className="flex-1 bg-red-100">
            ...
            <View className="flex-1 flex flex-col">
                <View className="flex flex-col px-[16px] items-center mt-[16px] mb-[21px] gap-[8px]">
                    <Text className="text-light-80 font-inter-bold text-[48px]">&#8377;{expenseDetail?.amount}</Text>
                    <Text className="text-light-80 font-inter-medium text-[13px]">{formatDate(expenseDetail?.date)}</Text>
                </View>
                <View className="flex-1 w-full bg-white">
                    ...
                    <View className="flex-1 bg-white px-[16px] relative pt-[55px] gap-[14px]">
                        <View className="absolute -top-[40px] left-[16px] right-[16px] flex flex-row justify-between w-full border-[1px] items-center border-light-60 px-[26px] py-[12px] rounded-[12px] bg-white">
                            <View className="flex flex-row gap-[80px] items-center">
                                <View className="flex flex-col gap-[9px] items-center">
                                    <Text className="text-light-20 text-[14px] font-inter-medium">Category</Text>
                                    <Text className="text-black text-[16px] font-inter-semibold">{expenseDetail?.category}</Text>
                                </View>
                                <View className="flex flex-col gap-[9px] items-center">
                                    <Text className="text-light-20 text-[14px] font-inter-medium">Wallet</Text>
                                    <Text className="text-black text-[16px] font-inter-semibold">{expenseDetail?.wallet}</Text>
                                </View>
                            </View>
                            <TouchableOpacity
                                onPress={() => {
                        ...
                        <View className="flex-1 flex flex-col justify-between">
                            <View className="flex flex-col gap-[15px]">
                                <Text className="text-light-20 text-[16px] font-inter-semibold">Description</Text>
                                <Text className="text-black text-[16px] font-inter-medium">{expenseDetail?.description}</Text>
                            </View>
                            <Pressable 
                            onPress={()=>{
                            ...
                            className="w-full mb-[16px]">
                                <View className="w-full bg-violet-100 rounded-[16px] p-[18px]">
                                    <Text className="text-center text-light-80 font-inter-semibold text-[18px]">Edit</Text>
                                </View>
                            </Pressable>
                        </View>
                    </View>
            ...
            <Modal transparent animationType="fade" visible={alertModal === 'success'}>
                ...
                >
                    <View className="w-full bg-white  rounded-[20px] px-[24px] py-[19px] flex flex-col gap-[8px] items-center">
                        ...
                        />
                        <Text className="text-[14px] font-inter-medium">Expense has been deleted successfully</Text>
                    </View>
                </TouchableOpacity>
            </Modal>
            <Modal transparent animationType="fade" visible={alertModal === 'fail'}>
                ...
                >
                    <View className="w-full bg-white  rounded-[20px] px-[24px] py-[19px] flex flex-col gap-[8px] items-center">
                        ...
                        />
                        <Text className="text-[14px] font-inter-medium">Expense Deletion failed!</Text>
                    </View>
                </TouchableOpacity>
            </Modal>
        </SafeAreaView>
