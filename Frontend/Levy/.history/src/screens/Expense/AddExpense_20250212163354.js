      ...
      <Modal transparent animationType="fade" visible={alertModal === 'success'}>
        ...
        >
          <View className="w-full bg-white  rounded-[20px] px-[24px] py-[19px] flex flex-col gap-[8px] items-center">
            ...
            />
            <Text className="text-[14px] font-inter-mediummedium">Expense has been successfully added</Text>
          </View>
        </TouchableOpacity>
      </Modal>
      <Modal transparent animationType="fade" visible={alertModal === 'fail'}>
        ...
        >
          <View className="w-full bg-white  rounded-[20px] px-[24px] py-[19px] flex flex-col gap-[8px] items-center">
            ...
            />
            <Text className="text-[14px] font-inter-mediummedium">Expense addition failed, try again later</Text>
          </View>
        </TouchableOpacity>
      </Modal>
    </SafeAreaView>
