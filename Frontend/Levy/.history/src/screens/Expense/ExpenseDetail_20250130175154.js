            ...
            <View className="flex-1 flex flex-col">
                ...
                <View className="flex-1 w-full bg-white">
                    ...
                    <View className="flex-1 bg-white px-[16px] relative">
                        <View className="absolute -top-[30px] left-[16px] right-[16px] flex flex-row justify-between w-full border-[1px] item border-light-60 px-[26px] py-[12px] rounded-[12px] bg-white">
