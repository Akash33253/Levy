  ...
  return (
    <SafeAreaView className="flex-1 bg-red-100">
      ...
      <Modal transparent animationType="fade" visible={alertModal}>
        ...
        >
          <View className="w-full bg-white  rounded-[30px] px-[24px] py-[19px] flex flex-col gap-[8px] items-center">
            <Image
              className="w-[64px] h-[64px]"
              source={require('../../../assets/images/success.png')}
            />
            <Text className="text-[14px] font-medium">Transaction has been successfully added</Text>
          </View>
        </TouchableOpacity>
      </Modal>
    </SafeAreaView>
