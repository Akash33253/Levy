                ...
                <View className="flex-1 relative bg-[rgba(0,0,0,0.5)] justify-end">
                    <View className="flex flex-col items-center gap-[16px] bg-white w-full rounded-t-[30px] pt-[26px] pb-[16px] px-[16px]">
                        ...
                        <View className="flex w-full flex-row items-center justify-between gap-[20px]">
                            <Pressable className="flex-1 py-[17px] flex items-center bg-violet-20 rounded-[16px]">
                                <Text className="text-violet-100 text-[16px] font-semibold">No</Text>
                            </Pressable>
                            <Pressable className="flex-1 py-[17px] flex items-center bg-violet-100 rounded-[16px]">
                                <Text>Yes</Text>
                            </Pressable>
