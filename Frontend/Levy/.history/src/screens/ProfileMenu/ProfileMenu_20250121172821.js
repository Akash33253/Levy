    ...
    <SafeAreaView className="flex-1 bg-[#F6F6F6]">
        <View className="flex flex-col gap-[40px]">
            ...
            <View className="flex flex-col mx-[20px] rounded-2xl bg-light-100">
                <View className="flex flex-row px-[17px] py-[15px] items-center gap-[9px] border-b-[1px] border-[#F6F6F6]"    >
                    <Image
                ...
                <View className="flex flex-row px-[17px] py-[15px] items-center gap-[9px]"    >
                    <Image
                    className="w-[52px] h-[52px]"
