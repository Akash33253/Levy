   ...
   const [fieldData, setFieldData] = useState({
    ...
    return (
      <SafeAreaView className="flex-1 bg-light-100">
        ...
        <View className="flex-1 w-full py-[55px] px-[16px] gap-[60px] flex-col">
          ...
          <View className="w-full flex flex-col gap-[16px] items-center">
            <Pressable className="w-full">
              <View className="w-[100%] bg-violet-100 rounded-[16px] p-[18px]">
