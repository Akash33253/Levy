            ...
            <View className="flex w-full py-[55px] px-[16px] gap-[60px] flex-col">
                ...
                <View className="flex flex-col gap-[33px] items-center">
                    ...
                    <View className="flex flex-row items-center">
                        <Text className="text-[16px] text-light-20 font-medium">Don't have an account? <Pressable><Text className="text-violet-100 text-[16px] font-medium">Sign up</Text></Pressable></Text>
                    </View>
                </View>
            </View>
        </SafeAreaView>
