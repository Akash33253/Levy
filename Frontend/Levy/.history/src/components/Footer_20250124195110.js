...
export default function Footer({ navigation }) {
    return (
        <View className="py-[10px] flex flex-row justify-between w-full items-center px-[50px] rounded-t-[30px] bg-white">
            <View className="absolute z-[1] top-0 left-1/2 ml-[20px] -mt-[15px] flex items-center justify-center w-[60px] h-[60px] bg-black">
                <Pressable className=" z-[2] bg-violet-100 w-[56px] h-[56px] flex items-center justify-center rounded-full">
                    <Image
