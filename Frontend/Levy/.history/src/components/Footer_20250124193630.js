...
export default function Footer({ navigation }) {
    return (
        <View className="py-[10px] flex flex-row justify-between w-full items-center px-[50px] rounded-t-[30px] bg-white">
            <Pressable className="absolute top-[-50%] left-1/2 -translate-x-1/2 -translate-y-1/2 bg-violet-100 w-[56px] h-[56px] flex items-center justify-center rounded-full">
                <Image
