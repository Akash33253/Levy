...
export default function Footer({ navigation }) {
    return (
        <View className="py-[10px] flex flex-row justify-between w-full items-center px-[50px] rounded-t-[30px] bg-white">
            <Pressable className="absolute top-0 left-1/2 ml-[20px] -mt-[15px] bg-violet-100 w-[60px] h-[60px] flex items-center justify-center rounded-full border-[10px] bg-transparent">
                <Image
