...
export default function Footer({ navigation ,color}) {
    ...
    return (
        <View className="py-[10px] flex flex-row justify-between w-full items-center px-[50px] rounded-t-[30px] bg-white">
            <View className={`absolute top-0 left-1/2 ml-[20px] -mt-[27px] flex items-center justify-center w-[70px] h-[70px] rounded-full bg-${color} bg-black`}>
            ...
            <Image
            className="w-[100px] backdrop-invert-0"
            source={require('../../assets/images/footerBar.png')}
            />
