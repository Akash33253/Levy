        ...
        <View className="p-[16px] flex flex-row items-center relative bg-transparent">
            <Pressable className="absolute left-[16px]"
                ...
                <Image
                    ...
                    source={title==='Expense'?require('../../assets/images/arrowLeft.png':require('../../assets/images/arrowLeft.png')}
                />
            </Pressable>
            <Text className={`text-center w-full font-semibold text-[18px] ${title==='Expense'?'text-white':''}`}>{title}</Text>
        </View>
    )
}
