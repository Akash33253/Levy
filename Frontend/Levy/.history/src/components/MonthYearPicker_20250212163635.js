    ...
    return (
        <View className="w-full">
            ...
            >
                ...
                />
                <Text className={`text-[16px] font-inter ${selectedMonthYear.month === '' ? 'text-light-20' : 'text-black'}`}>
                ...
                >
                    <View className="w-4/5 max-h-[300px] bg-white rounded-lg shadow-lg">
                        <View className="flex flex-row w-full justify-center items-center py-[10px]">
                            <TextInput
                                className="text-[18px] text-dark-50 font-inter-semibold border-[1px] border-dark-25 px-[16px] rounded-[30px]"
                                value={year}
                                placeholder='0000'
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                ...
                                >
                                    <Text className={`text-gray-800 font-inter`}>{item}</Text>
                                </TouchableOpacity>
                            )}
                        />
                    </View>
